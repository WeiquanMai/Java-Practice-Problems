 ...
 *
 * Write a test program that creates a MyRectangle2D object r1 (new MyRectangle2D
...
public class Exercise10_13 {
    public static void main(String[] args){
        ...
        System.out.println("Rectangle1 contains point(3, 3): " + r1.contains(3, 3));
        System.out.println("Rectangle1 contains rectangle(4, 5, 10.5, 3.2): "
                + r1.contains(new MyRectangle2D(4, 5, 10.5, 3.2)));
        System.out.println("Rectangle1 overlaps rectangle(3, 5, 2.3, 5.4): " +
