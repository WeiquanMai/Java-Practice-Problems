...
public class Exercise10_11 {
    public static void main(String[] args){
        ...
        System.out.println("Circle1 contains point (3, 3): " + c1.contains(3, 3));
        System.out.println("Circle1 contains Circle(4, 5, 10.5): " + c1.contains(new Circle2D(4, 5, 10.5)));
        System.out.println("Circle1 overlaps Circle(3, 5, 2.3): " + c1.overlaps(new Circle2D(3, 5, 2.3)));
    }
}
