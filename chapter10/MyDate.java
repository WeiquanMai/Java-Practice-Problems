...
class MyDate {
    ...
    public MyDate(){
        ...
        this.date = calendar.get(GregorianCalendar.DAY_OF_MONTH);
    }
    ...
    /**
     * A method named setDate(long elapsedTime) that sets a new date
    ...
    public void setDate(long elapsedTime){
        ...
        this.year = calendar.get(GregorianCalendar.YEAR);
        this.month = calendar.get(GregorianCalendar.MONTH);
        this.date = calendar.get(GregorianCalendar.DATE);
    }
}
