...
public class Exercise10_14 {
    public static void main(String[] args){
        ...
        System.out.println("Date1 year, month day: " + date1.getYear() + " " + date1.getMonth() + " " + date1.getDate());
        System.out.println("Date2 year, month day: " + date2.getYear() + " " + date2.getMonth() + " " + date2.getDate());
    }
}
